document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!panelModule || typeof panelModule.createPanelManager !== "function") {
    console.error("PanelManager module is not available.");
    return;
  }

  fetch("graph-data.json")
    .then((r) => r.json())
    .then((graphData) => initGraph(graphData, panelModule.createPanelManager))
    .catch((err) => {
...
function initGraph(graphData, createPanelManager) {
